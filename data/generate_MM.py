...
parser.add_argument('--tr_num', type=int, default=500,
...
parser.add_argument('--steps', type=int, default=500, help='simulation times steps')
...
def simulation(t):
    x0 = 1+np.random.uniform(0.,1.,size=(n,))
    x = odeint(michaelis_menten,x0,t)
...
if __name__ == '__main__':
    ...
    for exp_id in range(args.exp_num):
        ...
        data_path = 'MM_' + args.graph + str(n) + '_exp' + str(exp_id) +'.pickle'
